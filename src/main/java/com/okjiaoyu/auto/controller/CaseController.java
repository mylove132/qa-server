...
//import com.okjiaoyu.auto.vo.request.AddCaseRequestVo;
...
//        resultMap.put("casLoginUser",loginRequestVo.getUsername());
...
//    public BaseResponse addCasCrontroller(AddCaseRequestVo addCaseRequestVo){
//        BaseResponse baseResponse = caseService.addCaseService(addCaseRequestVo);
//        return baseResponse;
//    }
//
//
...
//
//    //@Operation("获取模块列表")
//    @RequestMapping(value = "/moduleListByProjectId",method = RequestMethod.GET)
//    public BaseResponse moduleCrontroller(Integer projectId, @RequestParam(defaultValue = "1",value = "currentPage") Integer pageNum,
//                                          @RequestParam(defaultValue = "10",value = "pageSize") Integer pageSize){
//        List<ModuleEntity> moduleList = moduleService.caseModuleListByProjectIdService(projectId,pageNum, pageSize);
//        return new SuccessResponse(new PageInfo(moduleList));
//    }
//
//    //@AuthPermission(PermissionConstant.VIP)
